...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->betweenness_output_help = gengetopt_args_info_help[30] ;
  args_info->ddist_output_help = gengetopt_args_info_help[31] ;
  args_info->log_bin_help = gengetopt_args_info_help[32] ;
  args_info->clustering_output_help = gengetopt_args_info_help[33] ;
  args_info->knn_output_help = gengetopt_args_info_help[34] ;
  args_info->shell_output_help = gengetopt_args_info_help[35] ;
  args_info->maxCliqueExact_output_help = gengetopt_args_info_help[36] ;
  args_info->maxCliqueAprox_output_help = gengetopt_args_info_help[37] ;
  args_info->output_file_help = gengetopt_args_info_help[38] ;
  args_info->print_deg_help = gengetopt_args_info_help[39] ;
